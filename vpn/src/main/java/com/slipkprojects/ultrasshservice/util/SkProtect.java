...
import com.socksxvpn.ph.BuildConfig;
...
public class SkProtect {
	...
	private static final String APP_BASE = "com.socksxvpn.ph";
	...
	public void simpleProtect() {
		if (!APP_BASE.equals(mContext.getPackageName().toLowerCase()) ||
				!mContext.getString(R.string.app_name).toLowerCase().equals("socks-x vpn")) {
			throw new RuntimeException();
		}
	}
